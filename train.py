...
def train(mnist_train, batch_size, training_epochs, learning_rate, total_batch, model, mnist_test)\
    ...
    for epoch in range(training_epochs):
        ...
        test_accuracy = test_model(model, mnist_test, 100)
    ...
    return train_cost, train_accu, load_model("model.pth")
